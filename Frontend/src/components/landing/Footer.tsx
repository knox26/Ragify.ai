...
const footerLinks = {
  ...
  Resources: ['Documentation', 'API Reference', 'Community', 'Guides'],
  Legal: ['Privacy Policy', 'Terms of Service', 'Cookie Policy', 'Security'],
};

export function Footer() {
  return (
    <footer className="border-t border-[var(--border-color)] pt-16 pb-8" style={{ backgroundColor: 'var(--bg-section)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-[var(--text-secondary)] mb-6 max-w-xs">
              AI-powered document intelligence. Chat with your documents, extract insights, and accelerate your research.
            </p>
        ...
        <div className="pt-8 border-t border-[var(--border-color)] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-[var(--text-secondary)]">
            © {new Date().getFullYear()} Ragify Inc. All rights reserved.
          </p>
